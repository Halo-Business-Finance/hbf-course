...
import { Plus, Edit, Trash2, Save, FileText, Globe } from "lucide-react";
...
export const CMSPageManager = () => {
  ...
  const getStatusBadge = (status: string) => {
    switch (status) {
      case 'published':
        return <Badge className="bg-accent/10 text-black">Published</Badge>;
      case 'draft':
        ...
        <CardContent>
          ...
          <Table>
              ...
              <TableRow key={page.id}>
                    ...
                    <TableCell>
                      <code className="px-2 py-1 rounded text-sm bg-white">{page.slug}</code>
                    </TableCell>
                    <TableCell>
                      {getStatusBadge(page.status)}
                    </TableCell>
                    <TableCell>
                      {page.is_homepage && <Badge className="text-primary bg-white"><Globe className="h-3 w-3 mr-1" />Homepage</Badge>}
                    </TableCell>
                    <TableCell>
