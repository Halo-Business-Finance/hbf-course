...
const CourseHeader = ({
  ...
  return (
    <div className="w-full bg-halo-navy">
      <div className="px-4 sm:px-6 lg:px-10 py-8 sm:py-10 lg:py-12 max-w-7xl mx-auto">
        ...
        <div className="inline-flex items-center gap-2 mb-5">
          ...
          <span className="text-xs font-semibold tracking-widest uppercase text-primary-foreground/80">
            Training Program
          </span>
        </div>

        {/* Title */}
        <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-primary-foreground leading-tight mb-3">
          Business Finance Mastery
        </h1>

        {/* Description */}
        <p className="text-sm sm:text-base text-primary-foreground/80 leading-relaxed max-w-2xl mb-6">
          Master the fundamentals of business finance with our comprehensive 
          training program designed for finance professionals.
        </p>

        {/* Stats Row */}
        <div className="flex flex-wrap items-center gap-4 sm:gap-6 mb-6 text-primary-foreground/80">
        ...
        <div className="max-w-lg mb-6">
          <div className="flex justify-between text-primary-foreground mb-2">
            ...
            <span className="text-xs sm:text-sm font-medium text-primary-foreground/70">
        ...
        <Button 
          ...
          size="lg"
          className="h-11 px-6 bg-halo-orange hover:bg-halo-orange/90 text-primary-foreground font-semibold rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 group"
        >
          Continue Learning
